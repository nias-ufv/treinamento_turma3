...
happy_tweets = 0
print("HAPPY:")
for i in happy_words: # a cada laço, i vai ser uma palavra da lista 'happy_words'
    for j in range(len(tweets)): # j vai percorrer o tamanho da lista 'tweets', e vai ser um número a cada laço
        if i in tweets[j]: # vendo se a palavra se encontra na lista 'tweets'
            happy_tweets += 1
            print("O tweet:")
            print(tweets[j])
...
sad_tweets = 0
print("SAD:")
# a cada laço, i vai ser uma palavra da lista sad_words
for i in sad_words: # a cada laço, i vai ser uma palavra da lista 'sad_words'
    for j in range(len(tweets)): # j vai percorrer o tamanho da lista 'tweets', e vai ser um número a cada laço
        if i in tweets[j]: # vendo se a palavra se encontra na lista 'tweets'
            sad_tweets += 1
            print("O tweet:")
